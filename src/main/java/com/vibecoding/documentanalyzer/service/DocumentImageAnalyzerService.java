package com.vibecoding.documentanalyzer.service;

import com.vibecoding.documentanalyzer.exception.ImageProcessingException;
import com.vibecoding.documentanalyzer.model.Base64Image;
...
@Service
public class DocumentImageAnalyzerService {

  private static final Logger log = LoggerFactory.getLogger(DocumentImageAnalyzerService.class);
  ...
  public DocumentImageAnalyzerService(ChatClient.Builder chatClientBuilder) {
